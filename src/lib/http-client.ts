...
export class HttpClient {
  ...
  async post<T>(url: string, data: any, options: { params?: Record<string, any>; headers?: Record<string, string> } = {}): Promise<{ data: T }> {
    const queryParams = new URLSearchParams();
    Object.entries({ ...this.params, ...options.params }).forEach(([key, value]) => {
      if (value !== undefined) {
        queryParams.append(key, String(value));
  ...
  async put<T>(url: string, data: any, options: { params?: Record<string, any>; headers?: Record<string, string> } = {}): Promise<{ data: T }> {
    const queryParams = new URLSearchParams();
    Object.entries({ ...this.params, ...options.params }).forEach(([key, value]) => {
      if (value !== undefined) {
        queryParams.append(key, String(value));
  ...
  async delete<T>(url: string, options: { params?: Record<string, any>; headers?: Record<string, string> } = {}): Promise<{ data: T }> {
    const queryParams = new URLSearchParams();
    Object.entries({ ...this.params, ...options.params }).forEach(([key, value]) => {
      if (value !== undefined) {
        queryParams.append(key, String(value));
